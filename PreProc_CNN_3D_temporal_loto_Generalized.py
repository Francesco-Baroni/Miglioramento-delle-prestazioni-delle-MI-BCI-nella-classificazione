...
SUBJECT_WISE_PERFORMANCE_METRIC_CSV_GENERALIZED = "PreProc_CNN_3D_temporal_loto_Generalized_subject_performance_metric.csv"
...
def train_model(X, y):
    ...
    for i, (train_index, test_index) in enumerate(logo.split(X, y, groups)):
        ...
        model = ProposedCNN(num_classes, channels, samples, filters, kernLength=63, F1=4, F2=8,  dropoutRate=0.5, dropoutType="Dropout")
        model.summary()
        ...
        # save the model
        model.save('saved_model/CNN3D_Generalized')
        ...
        plt.suptitle('PreProc_CNN_3D_temporal_Generalized Model Performance {} loto {}'.format(lhs, test_index[0]))
        plt.tight_layout()
        plt.savefig('graphs/PreProc_CNN_3D_temporal_Generalized Model Performance {} loto {}.png'.format(lhs, test_index[0]))
...
if __name__ == '__main__':
    ...
    for name in subject_filenames:
        ...
        for i in range(3):
            ...
            # temporal data
            x, y_tmp = multi_data_trial(x, channels=3)
